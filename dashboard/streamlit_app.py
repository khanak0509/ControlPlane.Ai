...
PRESETS = {
    ...
    "ShopSmart: Clean return query": {
        "use_case": "shopsmart",
        "session_id": "demo-shopsmart-clean",
    ...
    "ShopSmart: Wrong refund timeline (hallucination)": {
        "use_case": "shopsmart",
        "session_id": "demo-shopsmart-hallucination",
    ...
    "ShopSmart: Age bias": {
        "use_case": "shopsmart",
        "session_id": "demo-shopsmart-bias",
    ...
    "PeopleDesk: Colleague PII disclosure": {
        "use_case": "peopledesk",
        "session_id": "demo-peopledesk-pii",
    ...
    "PeopleDesk: Wrong leave entitlement": {
        "use_case": "peopledesk",
        "session_id": "demo-peopledesk-leave",
    ...
    "CreditLens: Fabricated approval": {
        "use_case": "creditlens",
        "session_id": "demo-creditlens-approval",
